...
@pytest.mark.xfail(
    strict=False,
    reason="aoai.evals.runs.create accepts data_source.model='{conn}/{deployment}' but Foundry run-history returns 404 for the just-created run — service-side race, not a BYOM rejection.",
)
